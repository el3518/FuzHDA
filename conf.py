...
#_C.MODEL.ADAPTATION = 'source_fuz'
...
# ------------------SETTING.DISTANT--------------- SOURCE options ---------------------------- #
_C.SOURCE = CfgNode()
...
_C.LCFD.TTA_STEPS = 1
#####################################################################
#_C.LCFD.NAME_FILE = './data/office-home/classname.txt'
# --------------------------------- DIFO options ----------------------------- #
_C.DIFO = CfgNode()
...
def load_cfg_from_args():
    ...
    parser.add_argument("--cfg", dest="cfg_file",default="cfgs/office-home/source_fuz.yaml", type=str,
                        help="Config file location")
    ...
    cfg.bottleneck = 768 #[512, 256, 1024, 768 ]
    cfg.distance = 'cosine'
    cfg.epsilon = 1e-5 #SOURCE.EPSILON = 1e-5
    ...
    if cfg.SETTING.DATASET == 'office-home':
        ...
        if cfg.DA == 'oda':
            cfg.class_num = 25
            cfg.name_file = './data/office-home/classname_25.txt'
    ...
    #cfg.output_dir = os.path.join(cfg.SAVE_DIR,cfg.DA,cfg.SETTING.DATASET,cfg.domain[cfg.SETTING.S][0].upper(),cfg.MODEL.METHOD)#+cfg.domain[cfg.SETTING.T][0].upper()
    cfg.output_dir = os.path.join(cfg.SAVE_DIR,cfg.DA,cfg.SETTING.DATASET,cfg.domain[cfg.SETTING.T][0].upper(),cfg.MODEL.METHOD)#bb_target
